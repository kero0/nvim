...
vim.keymap.set('n', '<leader>gf', "<Nop>", { desc = '[g]it [f]ile' })
...
vim.keymap.set('n', '<leader>gfb', function() vim.cmd.DiffviewFileHistory(vim.api.nvim_buf_get_name(0)) end, { desc = 'diffview [g]it [f]ile history (current [b]uffer)' })
