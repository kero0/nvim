...
keymap.set('n', '<leader>b', '<Nop>', { silent = true, desc = '+[b]uffer' })
keymap.set('n', '<leader>bk', vim.cmd.bdelete, { silent = true, desc = '[b]uffer [k]ill' })
keymap.set('n', '<leader>bn', vim.cmd.bnext, { silent = true, desc = '[b]uffer [n]ext' })
keymap.set('n', '<leader>bp', vim.cmd.bprevious, { silent = true, desc = '[b]uffer [p]revious' })
...
keymap.set('n', '<leader>f', "<Nop>", { desc = '+[f]ile' })
keymap.set('n', '<leader>fs', "<cmd>w<cr>", { desc = '[f]ile [s]ave' })
